...
```bash
git clone https://github.com/messaoudimaher/Emotion_recognition.git
...
```bash
cd src
python mood_recognition.py --mode display
```

* The needed files are:  
  * data (folder)
  * `mood_recognition.py` (file)
  * `haarcascade_frontalface_default.xml` (file)
  * `model.h5` (file)

* This implementation by default detects emotions on all faces in the webcam feed. With a simple 4-layer CNN, the test accuracy reached 82% in 50 epochs.
